CREATE TABLE users (id SERIAL PRIMARY KEY, username TEXT UNIQUE, password TEXT, created_at TIMESTAMP, visible BOOLEAN);
CREATE TABLE subforums (id SERIAL PRIMARY KEY, item_type TEXT, title TEXT, content TEXT, category TEXT, followers INTEGER, created_at TIMESTAMP, user_id INTEGER REFERENCES users, is_admin BOOLEAN, visible BOOLEAN);
