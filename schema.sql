...
CREATE TABLE follows_user (id SERIAL PRIMARY KEY, user_id1 INTEGER REFERENCES users, user_id2 INTEGER REFERENCES users);
CREATE TABLE follows_subforum (id SERIAL PRIMARY KEY, subforum_id INTEGER REFERENCES subforums, user_id INTEGER REFERENCES users);
